...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'meme ?(.*)', fromMe: true, desc: Lang.MEMES_DESC}, (async (message, match) => {   
	    ...
	    memeMaker({
            ...
            await message.client.sendMessage(message.jid, fs.readFileSync('sadsoul-meme.png'), MessageType.image, {filename: 'sadsoul-meme.png', mimetype: Mimetype.png, caption: 'Made by ﮩ٨ـﮩﮩ❂𝕳𝖆𝖗𝖎ঔ❂ﮩ٨ـﮩﮩ٨'});
            await info.delete();    
        });
    }));
}
